# ==========================================================================
#  ####  STALE — DO NOT RUN  ####  (2026-09-24)
#
#  End-of-module step 1 ran on 2026-09-24: "Module 1 - Full.pptx" was
#  assembled from "Module 1 - Revised.pptx" plus the taped decks in
#  "Recorded Video Slides/". Per rule 1 of that step, the .pptx is the
#  source of truth for Module 1 from here on and this script is not.
#
#  It was already two generations behind: it scaffolds the old 95-slide
#  content, without the 2026-09-23 in-class merge (95 -> 92 slides) and
#  without any of the edits Nico made while taping. _m1_frozen.py refuses
#  to let it write either deliverable.
#
#  It is kept as the record of how the deck's chrome, charts, tables and
#  OMML were generated. To add a NEW slide in the deck's style, build it
#  into a one-slide side deck with this helper layer and InsertFromFile it
#  into Full — never re-run main().
# ==========================================================================
...
OUT_DIR = Path(__file__).parent.parent   # the module folder; _build_files/ since 2026-09-24.parent   # the module folder; _build_files/ since 2026-09-24
