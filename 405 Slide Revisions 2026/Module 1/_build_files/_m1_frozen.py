...
# 2026-09-24: end-of-module step 1 produced "Module 1 - Full.pptx" from the
# Revised deck plus the taped decks in "Recorded Video Slides/", and step 2
# then produced "Module 1 - Final.pptx" from Full plus the hand-edited
# "Module 1 - In Class.pptx". Rule 1 of step 1 retires the build script for
# this module altogether, and each deck is edited in place from here on - so
# all three are guarded exactly like Revised. Final is the deliverable.
DELIVERABLES = (CANONICAL, "module 1 - full.pptx", "module 1 - final.pptx")
FORCE = "--force"
...
REFUSING TO WRITE "%s".
  ...
  as is "Module 1 - Full.pptx" built from it on 2026-09-24.
  Revised carries the in-class merge - 22 slides copied across by hand,
