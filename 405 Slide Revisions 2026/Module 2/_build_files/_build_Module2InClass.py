...
OUT_DIR = Path(__file__).parent       # _build_files/: images + sidecars
MODULE = OUT_DIR.parent               # decks live in the module folder (2026-09-25)
...
def build(out_path=None):
    ...
    out = Path(out_path) if out_path else MODULE / "Module 2 - In Class Revised.pptx"
    prs.save(str(out))
