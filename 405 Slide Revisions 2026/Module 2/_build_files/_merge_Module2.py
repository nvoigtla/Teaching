# -*- coding: utf-8 -*-
# STALE (2026-09-25): end-of-module step 1 made "Module 2 - Full.pptx" the
# deliverable, edited IN PLACE. This script no longer is the source of truth
# and never writes Full; rerunning it only regenerates the superseded decks.
...
MODULE = HERE.parent                  # decks live in the module folder (2026-09-25)
BASE = MODULE / "Module 2 - In Class Revised.pptx"
VIDEO = MODULE / "Module 2 - Video Part Revised.pptx"
# the "_red" suffix matters: _group_pass.py strips it to find the
# video deck's manual-group and spliced-slide tables
VIDEO_TMP = MODULE / "Module 2 - Video Part Revised_red.pptx"
OUT = MODULE / "Module 2 - Revised.pptx"
