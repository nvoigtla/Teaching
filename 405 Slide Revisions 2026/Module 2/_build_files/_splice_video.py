# -*- coding: utf-8 -*-
"""Splice the two live PollEverywhere slides from
"Module 2 - Video Part.pptx" into the built deck — phase-3
...
VF = HERE.parent / "Recorded Video Slides"   # renamed from "Videos Final" 2026-09-24
...
if __name__ == '__main__':
    ...
    deck = Path(args[0]) if args else HERE.parent / 'Module 2 - Video Part Revised.pptx'
    splice(deck)
