# -*- coding: utf-8 -*-
"""Grouping pass for "Module 4 - Revised.pptx" — merges shape
...
positions. GROUPING INVALIDATES ANIMATIONS — run BEFORE _animate.py:
  ...
  _build_Module4.py -> _splice_media.py -> _group_pass.py
...
DECK = Path(_a[0]) if _a else HERE / "Module 4 - Revised.pptx"
