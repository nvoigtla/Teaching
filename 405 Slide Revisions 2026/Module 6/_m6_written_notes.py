...
WRITTEN_NOTES = {
    ...
    8: ("Dilemma of Simple Pricing, Explained by the Podcast",
    ...
    9: ("What if Netflix Used Simple Pricing",
    ...
    15: ("Three Degrees of Price Discrimination",
    ...
    18: ("First Degree Price Discrimination",
         ...
         "would be."),
    21: ("The Dystopian Future of Price Discrimination",
    ...
    31: ("Recall from Videos: Ways to Segment Consumers",
    ...
    35: ("Consumer Segments in Medication",
    ...
    41: ("Challenges with Segment Pricing",
    ...
    49: ("More Examples for Versioning",
         ...
         "purpose."),
    51: ("Airline Response to Low-Cost Carriers",
    ...
    75: ("Costco: Combination of Versioning and Two-Part Pricing",
    ...
    83: ("How to Extract Consumer Surplus",
    ...
    94: ("Disneyland: Pricing Strategy",
    ...
    95: ("Disneyland: Third-Degree Price Discrimination",
    ...
    97: ("Disneyland: Second-Degree Price Discrimination",
    ...
    # the slide.
    100: ("Disneyland: What Strategy Is Where",
...
NOTE_FIXES = {
    26: ("Divide customers into different groups",
    ...
    60: ("Triangle = total value of unlimited movies",
    ...
    61: ("This pricing strategy is a mix of flat fee and versioning",
    ...
    79: ("Three purchase options",
         ...
         "surplus."),
    89: ("Customer attention focused on the comparison",
    ...
    90: ("Customer attention drawn to the comparison",
