# Carve the PollEverywhere slides out of "Module 6 - NV Slides\Module 6.pptx" into a small
...
# from a SIDECAR, never from the 18 MB source deck.
#
...
# the parser.
param(
    [string]$Source = "Module 6 - NV Slides\Module 6.pptx",
    [string]$Out    = "_handoff_polls_M6.pptx",
    [int[]] $Keep   = @(27, 40, 55)
)
